                        ...
                        <div class="md-card-content">
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-2">
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_ip_opd_or_whole_through" data-md-selectize name="ip_opd_or_whole_through" @if($errors->any())  @if(! old('ip_opd_or_whole')) disabled @endif  @else  @if(! $provider->ip_opd_or_whole) disabled @endif  @endif>
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_ip_opd_or_split_hb_hospital_through" data-md-selectize name="ip_opd_or_split_hb_hospital_through" @if($errors->any())  @if(! old('ip_opd_or_split_hb_hospital')) disabled @endif  @else  @if(! $provider->ip_opd_or_split_hb_hospital) disabled @endif  @endif>
                                            <option value="">Through...</option>
                                            @if ($errors->any())
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_ipd_opd_or_split_pf_doctor_through" data-md-selectize name="ip_opd_or_split_pf_doctor_through" @if($errors->any())  @if(! old('ip_opd_or_split_pf_doctor')) disabled @endif  @else  @if(! $provider->ip_opd_or_split_pf_doctor) disabled @endif  @endif>
                                            <option value="">Through...</option>
                                            @if ($errors->any())
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-2">
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_op_consult_referral_paid_to_hospital_through" data-md-selectize name="op_consult_referral_paid_to_hospital_through" @if($errors->any())  @if(! old('op_consult_referral_paid_to_hospital')) disabled @endif  @else  @if(! $provider->op_consult_referral_paid_to_hospital) disabled @endif  @endif>
                                            <option value="">Through...</option>
                                            @if ($errors->any())
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_op_consult_referral_paid_to_doctor_through" data-md-selectize name="op_consult_referral_paid_to_doctor_through" @if($errors->any())  @if(! old('op_consult_referral_paid_to_doctor')) disabled @endif  @else  @if(! $provider->op_consult_referral_paid_to_doctor) disabled @endif  @endif>
                                            <option value="">Through...</option>
                                            @if ($errors->any())
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-2">
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_clinic_setting_paid_to_hospital_through" data-md-selectize name="clinic_setting_paid_to_hospital_through" @if($errors->any())  @if(! old('clinic_setting_paid_to_hospital')) disabled @endif  @else  @if(! $provider->clinic_setting_paid_to_hospital) disabled @endif  @endif>
                                            <option value="">Through...</option>
                                            @if ($errors->any())
                                    ...
                                    <div class="uk-input-group">
                                        ...
                                        <select id="select_clinic_setting_paid_to_doctor_through" data-md-selectize name="clinic_setting_paid_to_doctor_through" @if($errors->any())  @if(! old('clinic_setting_paid_to_doctor')) disabled @endif  @else  @if(! $provider->clinic_setting_paid_to_doctor) disabled @endif  @endif>
                                            <option value="">Through...</option>
                                            @if ($errors->any())
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-2-3">
                                    ...
                                    <input id="field_mc_name" type="text" name="mc_name" value="{{ old('mc_name') ?: $provider->mc_name }}" class="md-input {{ $errors->has('mc_name') ? ' md-input-danger' : '' }}" />
                                ...
                                <div class="uk-width-1-3">
                                    ...
                                    <input id="field_mc_specialization" type="text" name="mc_specialization" value="{{ old('mc_specialization') ?: $provider->mc_specialization }}" class="md-input {{ $errors->has('mc_specialization') ? ' md-input-danger' : '' }}" />
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-1">
                                    ...
                                    <input id="field_mc_secretary_name" type="text" name="mc_secretary_name" value="{{ old('mc_secretary_name') ?: $provider->mc_secretary_name }}" class="md-input {{ $errors->has('mc_secretary_name') ? ' md-input-danger' : '' }}" />
                            ...
                            <div class="uk-grid">
                                <div class="uk-width-1-3">
                                    ...
                                    <input id="field_mc_clinic_hours"  type="text" name="mc_clinic_hours" value="{{ old('mc_clinic_hours') ?: $provider->mc_clinic_hours }}" class="md-input {{ $errors->has('mc_clinic_hours') ? ' md-input-danger' : '' }}" />
                                ...
                                <div class="uk-width-1-3">
                                    ...
                                    <input id="field_mc_room_no" type="text" name="mc_room_no" value="{{ old('mc_room_no') ?: $provider->mc_room_no }}" class="md-input {{ $errors->has('mc_room_no') ? ' md-input-danger' : '' }}" />
                                ...
                                <div class="uk-width-1-3">
                                    <label>Contact Number</label>
                                    <input id="field_mc_contact_number" type="text" name="mc_contact_no" value="{{ old('mc_contact_no') ?: $provider->mc_contact_no }}" class="md-input {{ $errors->has('mc_contact_no') ? ' md-input-danger' : '' }}" />
