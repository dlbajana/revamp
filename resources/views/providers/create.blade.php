                        ...
                        <div class="md-card-content">
                            ...
                            <div class="uk-grid uk-margin-medium-top">
                                <div class="uk-width-1-2">
                                    ...
                                    <p>
                                        <input type="radio" name="payment_terms" value="15" id="radio_payment_terms_15" data-md-icheck @if(old('payment_terms') == '15') checked @elseif(! old('payment_terms')) checked @endif/>
                                ...
                                <div class="uk-width-1-2">
                                    ...
                                    <p>
                                        <input type="radio" name="submission_of_claims" value="7" id="radio_submission_of_claims_7" data-md-icheck @if(old('submission_of_claims') == '7') checked @elseif(! old('submission_of_claims')) checked @endif/>
